...
//   url: "https://boss-glider-21245.upstash.io",
//   token: "AVL9AAIjcDEzMzE4ZDE0NDRkYjM0ODFjODUzNzM3OWI3ZTBiODdjMnAxMA",
// })
...
//     // TODO: Load chat history from backend using `id`
//   }, [])
...
//   // Add a manual scroll function that can be called when needed
...
//       { type: "AIMessage", content: "Processing..." },  // AI message
//     ];
...
//           text: message,
//           user_id: userId,
//           chat_history: chatHistory,  // send it directly as it is
//         }),
//       });
  
//       const data = await response.json();
//       // Replace the "Typing..." with the actual response
//       newChat[newChat.length - 1].content = data.response_text;
//       setChatHistory([...newChat]);

//     } catch (error) {
//       console.error("Error sending message:", error);
//       newChat[newChat.length - 1].content = "Sorry, something went wrong.";
//       setChatHistory([...newChat]);
//     }
//   };
...
//     // TODO: Clear history from Redis via backend
//   }
...
//   <h2 className="font-clashMedium text-2xl md:text-4xl text-white text-center mb-2"> Chat with <span className="text-primary-100"> Swel Pay Lar </span> </h2>  
...
//   {chatHistory !== null && chatHistory.map((msg, idx) => (
